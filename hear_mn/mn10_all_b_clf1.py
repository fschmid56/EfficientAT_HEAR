...
def load_model(model_file_path="", model_name="mn10_as", mode=("b5", "b11", "b13", "b15", "clf1")):
...
def get_basic_model(model_name="mn10_as", **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=1432, timestamp_embedding_size=1432, **kwargs)
    return model
