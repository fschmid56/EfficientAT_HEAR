...
def load_model(model_file_path="", model_name="mn04_as", mode="all"):
...
def get_basic_model(model_name="mn04_as", **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=911, timestamp_embedding_size=911, **kwargs)
    return model
