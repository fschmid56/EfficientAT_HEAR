...
def get_basic_model(model_name="mn10_as", feature_pooling_fn=feature_pooling.avg_time_pool, **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=2944, timestamp_embedding_size=2944, **kwargs)
    return model
