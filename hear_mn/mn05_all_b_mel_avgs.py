...
def load_model(model_file_path="", model_name="mn05_as", mode=("b5", "b11", "b13", "b15", "mel_avgs")):
...
def get_basic_model(model_name="mn10_as", **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=368, timestamp_embedding_size=368, **kwargs)
    return model
