...
def load_model(model_file_path="", model_name="mn05_as", mode=("b5", "b11", "b13", "b15"),
...
def get_basic_model(model_name="mn05_as", feature_pooling_fn=feature_pooling.avg_max_time_pool, **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=1472, timestamp_embedding_size=1472, **kwargs)
    return model
