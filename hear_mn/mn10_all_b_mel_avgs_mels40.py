...
def load_model(model_file_path="", model_name="mn10_as_mels_40", mode=("b5", "b11", "b13", "b15", "mel_avgs")):
...
def get_basic_model(model_name="mn10_as_mels_40", **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=512, timestamp_embedding_size=512, **kwargs)
    return model
