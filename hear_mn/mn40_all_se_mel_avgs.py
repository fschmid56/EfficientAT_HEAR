...
def load_model(model_file_path="", model_name="mn40_as", mode=("se5", "se11", "se13", "se15", "mel_avgs")):
...
def get_basic_model(model_name="mn10_as", **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=2360, timestamp_embedding_size=2360, **kwargs)
    return model
