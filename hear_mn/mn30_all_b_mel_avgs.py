...
def load_model(model_file_path="", model_name="mn30_as", mode=("b5", "b11", "b13", "b15", "mel_avgs")):
...
def get_basic_model(model_name="mn30_as", **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=1544, timestamp_embedding_size=1544, **kwargs)
    return model
