...
def load_model(model_file_path="", model_name="mn10_as", mode=("b5", "b11", "b13", "b15", "mel_avgs"),
...
def get_basic_model(model_name="mn10_as", feature_pooling_fn=feature_pooling.cat_avg_max_ch_pool, **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=1072, timestamp_embedding_size=1072, **kwargs)
    return model
