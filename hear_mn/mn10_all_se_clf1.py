...
def load_model(model_file_path="", model_name="mn10_as", mode=("se5", "se11", "se13", "se15", "clf1")):
...
def get_basic_model(model_name="mn10_as", **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=1520, timestamp_embedding_size=1520, **kwargs)
    return model
