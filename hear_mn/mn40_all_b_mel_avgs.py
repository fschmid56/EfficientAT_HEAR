...
def load_model(model_file_path="", model_name="mn40_as", mode=("b5", "b11", "b13", "b15", "mel_avgs")):
...
def get_basic_model(model_name="mn40_as", **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=2016, timestamp_embedding_size=2016, **kwargs)
    return model
