...
def get_basic_model(model_name="mn10_as", feature_pooling_fn=feature_pooling.add_avg_max_ch_pool, **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=600, timestamp_embedding_size=600, **kwargs)
    return model
