...
def load_model(model_file_path="", model_name="mn10_as_fc", mode=("b5", "b11", "b13", "b15", "mel_avgs"),
...
def get_basic_model(model_name="mn10_as_fc", head_type="fully_convolutional", **kwargs):
    ...
    net = get_model(width_mult=NAME_TO_WIDTH(model_name), pretrained_name=model_name, head_type=head_type)
