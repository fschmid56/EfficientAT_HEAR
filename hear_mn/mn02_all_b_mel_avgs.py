...
def load_model(model_file_path="", model_name="mn02_as", mode=("b5", "b11", "b13", "b15", "mel_avgs")):
...
def get_basic_model(model_name="mn02_as", **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=224, timestamp_embedding_size=224, **kwargs)
    return model
