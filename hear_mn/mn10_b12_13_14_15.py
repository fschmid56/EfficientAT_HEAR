...
def load_model(model_file_path="", model_name="mn10_as", mode=("b12", "b13", "b14", "b15"), all_blocks=True):
...
def get_basic_model(model_name="mn10_as", **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=592, timestamp_embedding_size=592, **kwargs)
    return model
